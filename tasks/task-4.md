...
## Overview
You are a senior Go backend engineer. I want you to implement **OpenTelemetry** for tracing in the Go project, allowing us to trace requests and the system’s performance.
